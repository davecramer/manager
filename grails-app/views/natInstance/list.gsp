...
<html>
	...
	<body>
		<a href="#list-natInstance" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="list-natInstance" class="content scaffold-list" role="main">
			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="instanceId" title="${message(code: 'natInstance.instanceId.label', default: 'InstanceId')}" />
					
						<g:sortableColumn property="host" title="${message(code: 'natInstance.host.label', default: 'Host')}" />
					
						<g:sortableColumn property="identity" title="${message(code: 'natInstance.identity.label', default: 'Identity')}" />
					
						<g:sortableColumn property="loginUser" title="${message(code: 'natInstance.loginUser.label', default: 'Login User')}" />
				...
				<g:each in="${natInstanceInstanceList}" status="i" var="natInstanceInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${natInstanceInstance.id}">${fieldValue(bean: natInstanceInstance, field: "instanceId")}</g:link></td>
			...
			<div class="pagination">
				<g:paginate total="${natInstanceInstanceTotal}" />
			</div>
		</div>
	</body>
</html>
