...
<html>
	...
	<body>
		<a href="#list-mobileServer" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="list-mobileServer" class="content scaffold-list" role="main">
			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="identity" title="${message(code: 'mobileServer.identity.label', default: 'Identity')}" />
					
						<g:sortableColumn property="loginUser" title="${message(code: 'mobileServer.loginUser.label', default: 'Login User')}" />
					
						<g:sortableColumn property="replica" title="${message(code: 'mobileServer.replica.label', default: 'Replica')}" />
				...
				<g:each in="${mobileServerInstanceList}" status="i" var="mobileServerInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:formatBoolean boolean="${mobileServerInstance.replica}" /></td>
			...
			<div class="pagination">
				<g:paginate total="${mobileServerInstanceTotal}" />
			</div>
		</div>
	</body>
</html>
